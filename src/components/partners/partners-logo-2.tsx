...
const PartnersLogosTwo = () => {
  return (
    <div className="partner-logo-two position-relative z-3">
      <div className="bg-wrapper">
        <div className="wrapper m-auto d-xl-flex align-items-center justify-content-center">
          <h3 className="title font-magnita d-flex justify-content-center align-items-center m0 lg-pb-30">
            <span className="fw-bold">100+</span> Trusted{" "}
