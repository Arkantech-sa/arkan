...
const AboutUs = ({ style_2 = false }: { style_2?: boolean }) => {
  return (
    <>
      {!style_2 && (
          ...
          <div className="container">
            ...
            <div className="counter-wrapper mt-80 lg-mt-20">
              <div className="row">
                ...
                <CounterBlock num={1} text="K+" title="Successful Projects" delay="4" />
                <CounterBlock num={1.2} text="%" title="Low interest rate" delay="6" />
              </div>
            </div>
          </div>
        </div>
