...
import loader from "@/assets/images/logo/favicon.ico";
...
const Preloader = () => {
  ...
  return (
    <div id="preloader" className="fixed inset-0 bg-black flex items-center justify-center z-50 transition-opacity duration-500">
